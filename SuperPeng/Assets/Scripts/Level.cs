...
public class Level : MonoBehaviour
{
    ...
    private float cloudSpawnTimerMax = 7f;
    ...
    private void HandleGround()
    {
        foreach(Transform groundTransform in groundList)
        {
            ...
            {
                //Ground passed on the left side, relocate on the right side
                ...
                //Place ground on the rightmost position
                float groundWidth = 191.5f;
